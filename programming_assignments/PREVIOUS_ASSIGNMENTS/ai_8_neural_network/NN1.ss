...
; I took the weights for XOR logic function from NN0.ss and multiplied it by 50
; When I run these set of weights, I get the following output
...
;(define threshold-weights '(((30 50 -25) (30 -25 50)) ((-25 -50 -50))))
; I took the weights for NOT XOR logic function from NN0.ss and multiplied it by 50
; When I run these set of weights, I get the following output
; Input: (0 0) | Output: 0.99999 | Larger than 0.5 --> 1
; Input: (0 1) | Output: 0.0000000000139 | Smaller than 0.5 --> 0
; Input: (1 0) | Output: 0.0000000000139 | Smaller than 0.5 --> 0
; Input: (1 1) | Output: 0.99999 | Larger than 0.5 --> 1
