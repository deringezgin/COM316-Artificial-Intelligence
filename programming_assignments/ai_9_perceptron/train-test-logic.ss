...
(display "==================== Training the perceptron for OR using different epsilon values ====================")
(newline)
...
(newline)
(newline)
(display "==================== Training the perceptron for AND using different epsilon values ====================")
(newline)
(run-test training-input-and test-epsilon test-generation)

(newline)
(newline)
(newline)
(display "==================== Training the perceptron for XOR using different epsilon values ====================")
(newline)
(run-test training-input-xor test-epsilon test-generation)
